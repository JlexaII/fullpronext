    ...
    return (
      <footer>
        <div className="wrapper">
          ...
          <div className="foot">
            <div className="copy">
              Copyright © Holland & Barrett Retail Limited, 2025. All rights reserved.
              hollandandbarrett.com is a trading name of Holland & Barrett Retail Limited,.
            </div>
            <div className="link">
            ...
            <div className="design">
              <a href="#">
                ...
                <svg width="63" height="26" viewBox="0 0 63 26" fill="none" xmlns="https://www.w3.org/2000/svg">
                  <path
